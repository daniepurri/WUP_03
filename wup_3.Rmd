...
There are "bites" on the boxes that are on the plot above. They represent the standard deviation, which is the ammount of deviations amongs the data.   
